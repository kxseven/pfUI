pfUI:RegisterModule("pet", function ()
  ...
  pfUI.uf.pet.hp.text:SetFont(pfUI.font_square, pfUI_config.global.font_size - 2, STANDARD_TEXT_FONT_FLAGS)
  ...
  for i=1, 16 do
    ...
    pfUI.uf.pet.buff.buffs[i].stacks:SetFont(pfUI.font_square, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  for i=1, 16 do
    ...
    pfUI.uf.pet.debuff.debuffs[i].stacks:SetFont(pfUI.font_square, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
